...
public class WifiPassword {
    public List<WifiInfo> Read() throws Exception {
        ...
        while (networkMatcher.find()) {
            ...
            System.out.println("networkBlock:" + networkBlock);
            ...
            Pattern keyp = Pattern.compile("key_mgmt=(.+)\\s|key_mgmt=(.+)\\}");
            Matcher keypMatcher = keyp.matcher(networkBlock);
            if (keypMatcher.find()) {
                wifiInfo.Keymgmt = keypMatcher.group(1);
            }
